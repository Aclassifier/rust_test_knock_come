...
const CURRENT_APP_NAME: &str = match CURRENT_SEMANTICS { // Name for Terminal window and the .app as built by build_app.sh
    ...
    TaskSemantics::MasterForceSendSlaveSelect  => "KnockComeForce",  // "knockcomeforce" 
    TaskSemantics::MasterTrySendSlaveSelect    => "KnockComeTry",    // "knockcometry"
    TaskSemantics::MasterSendSlaveNestedSelect => "KnockComeNested", // "knockcomenested"
};
